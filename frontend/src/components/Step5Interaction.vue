        ...
        <div v-if="activeTab === 'chat'" class="chat-container">
          ...
          <div v-if="chatTarget === 'report_agent'" class="report-agent-tools-card">
            <div class="tools-card-header">
              ...
              <div class="tools-card-info">
                ...
                <div class="tools-card-subtitle">Quick-chat version of the Report Agent. Has access to 4 specialized tools and Future Lab's full memory.</div>
              </div>
              ...
              <div class="tools-grid">
                <div class="tool-item tool-purple">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Aligns real-world seed data with simulation state, leveraging Global/Local Memory for cross-temporal deep attribution analysis.</div>
                  </div>
                </div>
                <div class="tool-item tool-blue">
                  ...
                  <div class="tool-content">
                    <div class="tool-name">PanoramaSearch — Full Coverage Tracking</div>
                    <div class="tool-desc">Graph-based breadth-first traversal that reconstructs event propagation paths and captures the full information flow topology.</div>
                  </div>
                </div>
                ...
                <div class="tool-item tool-green">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Autonomous interview agent that conducts parallel multi-round conversations with simulated individuals to collect unstructured opinion data and psychological states.</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="chat-messages" ref="chatMessages">
            <div v-if="chatHistory.length === 0" class="chat-empty">
              ...
              <p class="empty-text">
                {{ chatTarget === 'report_agent' ? 'Chat with Report Agent to dive deeper into the report.' : 'Chat with a simulated individual to learn their perspective.' }}
              </p>
            </div>
            <div 
...
const sendToAgent = async (message) => {
  ...
  if (chatHistory.value.length > 1) {
    const historyContext = chatHistory.value
      ...
      .slice(-6)
      .map(msg => `${msg.role === 'user' ? 'Interviewer' : 'Agent'}：${msg.content}`)
      .join('\n')
...
const loadProfiles = async () => {
  ...
  try {
    ...
    addLog(`Agent load failed: ${err.message}`)
  }
}
