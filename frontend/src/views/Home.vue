<template>
  <div class="home-container">
    <!-- 顶部导航栏 -->
    <nav class="navbar">
      <div class="nav-brand">FUTURE LAB</div>
      <div class="nav-links">
    ...
    <div class="main-content">
      ...
      <section class=”hero-section”>
        <div class=”hero-center”>
          ...
          <div class=”hero-desc”>
            <p>
              Even from a single paragraph, <span class=”highlight-bold”>Future Lab</span> can extract reality seeds and auto-generate a parallel world of up to <span class=”highlight-orange”>millions of Agents</span>. Inject variables from a god's-eye view and discover the <span class=”highlight-code”>”local optimum”</span> within complex group interactions.
            </p>
            <p class=”slogan-text”>
            ...
            <div class="workflow-list">
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Entity extraction & persona generation & simulation parameter injection</div>
                </div>
              </div>
              <div class="workflow-item">
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Chat with any simulated agent & chat with ReportAgent</div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  class="code-input"
                  placeholder="// Describe your simulation or prediction goal in natural language (e.g. If a university revokes a disciplinary decision, what public opinion shift would follow?)"
                  rows="6"
                  :disabled="loading"
                ></textarea>
                <div class="model-badge">Engine: Future Lab-V1.0</div>
              </div>
            </div>
